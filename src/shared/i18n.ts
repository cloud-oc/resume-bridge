...
const dictionaries: Dictionaries = {
  en: {
    ...
    'sidebar.workflow.fill.desc': 'Rules suggest, AI can refine when configured',
    ...
    'sidebar.result.aiGenerated': 'AI generated, review',
    'sidebar.result.aiMatched': 'AI matched, check',
    ...
    'sidebar.help.first.2': 'If you need stronger field planning, open-answer drafting, or resume import, add an API key in AI model settings.',
    ...
    'options.experience.url': 'Link',
    'options.experience.urlPlaceholder': 'Project, demo, portfolio, or company URL',
    ...
    'resume.needModelTitle': 'AI model required',
    'resume.needModelDesc': 'Resume import uses your active AI model to structure the extracted text. Configure and activate a model before uploading.',
    'resume.checkingModel': 'Checking active AI model...',
    'resume.configureModel': 'Configure AI model',
    ...
    'resume.previewCount': '{count} importable item(s)',
    'resume.previewEmpty': 'No importable fields were recognized. Try a clearer Word/TXT resume or adjust the AI model output.',
    'resume.name': 'Name',
    'resume.phone': 'Phone',
    'resume.email': 'Email',
    ...
    'options.help.step3.desc':
      'Rule matching works without AI. With a model configured, AI can review candidates across the whole form, correct ambiguous fields, draft open answers, and import resumes.',
  ...
  zh: {
    ...
    'sidebar.workflow.fill.desc': '规则先给候选，已配置时由 AI 规划修正',
    ...
    'sidebar.result.aiGenerated': 'AI 生成，需复核',
    'sidebar.result.aiMatched': 'AI 匹配，建议确认',
    ...
    'sidebar.help.first.2': '需要更强的字段规划、开放题生成或简历导入时，在 AI 模型配置里添加 API Key，并设为默认。',
    ...
    'options.experience.url': '链接',
    'options.experience.urlPlaceholder': '项目、演示、作品或公司官网链接',
    ...
    'resume.needModelTitle': '需要先配置 AI 模型',
    'resume.needModelDesc': '简历导入需要使用当前激活的 AI 模型把文本整理成结构化资料。请先配置并激活模型，再上传简历。',
    'resume.checkingModel': '正在检查当前 AI 模型...',
    'resume.configureModel': '去配置 AI 模型',
    ...
    'resume.previewCount': '可入库 {count} 项',
    'resume.previewEmpty': '没有识别到可写入资料库的字段。请尝试使用文本更清晰的 Word/TXT 简历，或检查 AI 模型返回内容。',
    'resume.name': '姓名',
    'resume.phone': '手机',
    'resume.email': '邮箱',
    ...
    'options.help.step3.desc': '规则匹配不依赖 AI。配置模型后，AI 会结合整页字段复核候选、修正歧义字段、生成开放题草稿并支持简历解析，API Key 只保存在本地浏览器。',
  ...
  ja: {
    ...
    'sidebar.workflow.fill.desc': 'ルール候補を、設定済み AI が確認・修正',
    ...
    'sidebar.result.aiGenerated': 'AI 生成、確認',
    'sidebar.result.aiMatched': 'AI マッチ、確認',
    ...
    'sidebar.help.first.2': 'より強い項目プランニング、自由回答、履歴書インポートが必要な場合は、AI モデル設定で API Key を追加します。',
    ...
    'options.experience.url': 'リンク',
    'options.experience.urlPlaceholder': 'プロジェクト、デモ、ポートフォリオ、会社サイトの URL',
    ...
    'resume.needModelTitle': 'AI モデルの設定が必要です',
    'resume.needModelDesc': '履歴書インポートは、有効な AI モデルで抽出テキストを構造化します。アップロード前にモデルを設定して有効化してください。',
    'resume.checkingModel': '有効な AI モデルを確認しています...',
    'resume.configureModel': 'AI モデルを設定',
    ...
    'resume.previewCount': '保存可能な項目 {count} 件',
    'resume.previewEmpty': '保存できる項目を認識できませんでした。より鮮明な Word/TXT 履歴書を使うか、AI モデルの出力を確認してください。',
    'resume.name': '氏名',
    'resume.phone': '電話',
    'resume.email': 'メール',
